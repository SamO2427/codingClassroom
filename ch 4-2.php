<?php
	...
	if ($row[0] < 32)
	{
		$sql = "UPDATE account SET progress=32 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				Local variable will be destroyed outside the function
			</p>
			<p>
				So, 2 function can have the same variable name
			</p>
			<p>
				For example,
			</p>
			...
			<p>Both variable c are local variable but they are NOT related</p>
		</div>

		<div id="question">
			<h3 style="text-align: center">Little Quiz</h3>
			<p>
				What is the value of variable c in function a?
			</p>
