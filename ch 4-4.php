<?php
	...
	if ($row[0] < 34)
	{
		$sql = "UPDATE account SET progress=34 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				When value of a global variable is changed inside a function, the actual value the variable will be changed if we call the function</p>
			<p>
				int a = 1;
			</p>
			<p>
			...
			<p>
				After calling function y, value of a=1+2=3
			</p>
			<p>Then, function x is called, so value of a=3+1=4</p>
		</div>
		...
		<div id="question">
			...
			<p>{b=b+b-1;}</p>
			<p>z();</p>
			<p>What is value of b after the code above?</p>
