<?php
	...
	if ($row[0] < 16)
	{
		$sql = "UPDATE account SET progress=16 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				There is another loop: do-while-loop
			</p>
			<p>
				int candy = 0;
			</p>
			...
			<p>do-while-loop will do at least 1 loop, which is not the same as while-loop and for-loop</p>
		</div>
		...
		<div id="question">
			...
			<button id="btn3" onclick="Alert1.render('Well Done! You are correct! You can move on to exercise part of chapter 2')">
				do-for-loop
			</button>
		</div>
		<div id="dbox">
