<?php
	...
	if ($row[0] < 28)
	{
		$sql = "UPDATE account SET progress=28 WHERE username = '{$_SESSION['login_user']}'";
	}
		...
		<script>
			...
			function correct() {
				...
				if (c == true && d == true && f == true) {
					Alert1.render('Well Done! You are correct! <br> Chapter 3 is completed!<br> You can now move on to Chapter 4!<br>Congratulations!!');
					document.getElementById('next').style.display = "block";
				} else {
	...
	<body>
		...
		<div id="menu">
			...
			<p style="font-size: 30px">
				What are a,b and c on the left?
			</p>
			<div id="menu1">
				<p>a:
