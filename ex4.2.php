<?php
	...
	if ($row[0] < 38)
	{
		$sql = "UPDATE account SET progress=38 WHERE username = '{$_SESSION['login_user']}'";
	}
		...
		<script>
			...
			function correct() {
				...
				if (c == true && d == true && f == true) {
					Alert1.render('Well Done! You are correct! <br> Chapter 4 is completed!<br> You can now move on to Chapter 5!<br>Congratulations!!');
					document.getElementById('next').style.display = "block";
				} else {
	...
	<body>
		...
		<div id="menu">
			...
			<p style="font-size: 30px">
				From the code on the left, what is the value of c,d,e?
			</p>
			<div id="menu1">
				<p>c:
