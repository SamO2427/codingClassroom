<?php
	...
	if ($row[0] < 45)
	{
		$sql = "UPDATE account SET progress=45 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>Inside a class, we should have a member function called constructor</p>
			<p>
				class abc
			</p>
			<p>
			...
			<p>In the class above, the constructor is abc(), and you can see that constructor has the same name with the class</p>
			<p>Also, constructor is the only function that has NO return type</p>
		</div>

		<div id="question">
			<h3 style="text-align: center">Little Quiz</h3>
			<p>
				If we create a new class def, what is the name of the constructor?
			</p>
