<?php
	...
	if ($row[0] < 4)
	{
		$sql = "UPDATE account SET progress=4 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				With the code: int candies = 3;
			</p>
			<p>
				The code for ouput can be changed to:
			</p>
			<p style="text-align: center">
				cout << "I have " << candies << " candies";
			</p>
			<p>
				1st candies is name of variable
			</p>
			<p>
				2nd candies in " " is the words to show
			</p>
			<p>
				<< is also required between name of variable and " "
			</p>
			<p>
