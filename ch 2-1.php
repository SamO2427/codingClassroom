<?php
	...
	if ($row[0] < 11)
	{
		$sql = "UPDATE account SET progress=11 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>	
	...
	<body>	
		<div id="notes">
			<p>When playing a game, you first have 10 points</p>
			<p>int pts = 0;</p>
			<p>When you win, you get 10 more points</p>
			<p>We use w as a variable to show win or loss</p>
			<p>If w is true, it means you win</p>
			<p>if(w == true)</p>
		...
		<div id="question">
			...
			<p>
				What is the value of pts if you win?
			</p>
