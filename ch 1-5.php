<?php
	...
	if ($row[0] < 5)
	{
		$sql = "UPDATE account SET progress=5 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				When we eat 1 of the 3 candies, 2 candies are left
			</p>
			<p>
				We can change the value of candies to 2 by code:
			</p>
			<p style="text-align: center">
				candies = 2;
			</p>
			<p>
				or candies = candies - 1;
			</p>
			<p>
				1st candies is variable we have
			</p>
			<p>
				2nd candies is value 3
			</p>
			<p>
				Now, value of candies becomes 2
			</p>
		</div>
		...
		<div id="question">
			...
			<p>apples = apples - 2;</p>
			<p>What is value of apples now</p>
