<?php
	...
	if ($row[0] < 31)
	{
		$sql = "UPDATE account SET progress=31 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				Local variables are made in the function
			</p>
			<p>
				int x(int a)
			</p>
			...
			<p>
				In the function above, variable c is a local variable
			</p>
			<p>
				We cannot call variable c outside the function unless we make another variable c outside the function
			</p>
		</div>
		...
		<div id="question">
			...
			<p>
				Where are local variables be made?
			</p>
