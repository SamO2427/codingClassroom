<?php
	...
	if ($row[0] < 7)
	{
		$sql = "UPDATE account SET progress=7 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>	
	...
	<body onload="ex1lock()">
		...
		<div id="menu">
			<p>Menu</p>
			<a href="./ex1.1.php"><button id="button1" class="option">Ex1.1</button></a>
			<br>
			<a href="./ex1.2.php"><button id="button2" class="option">Ex1.2</button></a>
			<br>
			<a href="./chapter1.php"><button id="button3" class="option">Back</button></a>
		</div>
