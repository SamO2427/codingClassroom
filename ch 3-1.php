<?php
	...
	if ($row[0] < 21)
	{
		$sql = "UPDATE account SET progress=21 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				We can use function for different purposes
			</p>
			<p>
			...
			<p>
				Every function need to have a name and a return type
			</p>
			<p>
				The name is for the function above is add and int is return type
			</p>
		</div>
		...
		<div id="question">
			...
			<p>{return a;}</p>
			<p>What is the name of the above function?</p>
