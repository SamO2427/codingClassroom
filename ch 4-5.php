<?php
	...
	if ($row[0] < 35)
	{
		$sql = "UPDATE account SET progress=35 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				One special type of local variable is static local variable
			</p>
			<p>
				When static local variable is changed inside the function, the changes will be saved when the function is being called again
			</p>
			<p>
				int a()
			</p>
			...
			<p>y=y+1;x=x+1; return x;}</p>
			<p>
				int b=a(); int c=a();
			</p>
			<p>The code static int x = 1 only run for 1 time in the whole program</p>
			<p>
				Value of b = 2 as x becomes 2 after function a is called  
			</p>
			<p>When function a is called again, as the function will keep x=2 and run x=x+1</p>
			<p>So value of c=2+1=3</p>
		</div>

		<div id="question">
			<h3 style="text-align: center">Little Quiz</h3>
			<p>
				If return x is changed to return y, what is the value of c?
			</p>
