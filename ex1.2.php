		...
		<script>
			...
			function correct() {
				...
				if (c == true && d == true && f == true) {
					Alert1.render('Well Done! You are correct! <br> Chapter 1 is completed!<br> You can now move on to Chapter 2!<br>Congratulations!!');
					document.getElementById('next').style.display = "block";
				} else {
	...
	<body>
		...
		<div id="menu">
			...
			<p style="font-size: 30px">
				Move the match type to the blanks below
			</p>
			<div id="menu1">
				<p>1,2,3:
