<?php
	...
	if ($row[0] < 27)
	{
		$sql = "UPDATE account SET progress=27 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>	
	...
	<body onload="ex3lock()">
		...
		<div id="menu">
			<p>Menu</p>
			<a href="./ex3.1.php"><button id="button1" class="option">Ex3.1</button></a>
			<br>
			<a href="./ex3.2.php"><button id="button2" class="option">Ex3.2</button></a>
			<br>
			<a href="./chapter3.php"><button id="button3" class="option">Back</button></a>
		</div>
