<?php
	...
	if ($row[0] < 26)
	{
		$sql = "UPDATE account SET progress=26 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			...
			<p>
				For array, we can use for loop to do the same things to all elements in the array
			</p>
			<p>
				For example, if we want to add 5 apples for all 3 sizes, we can use the code
			</p>
			<p>
			...
			<p>
				Now, value of apple[0], apple[1], apple[2] are 18, 16, 21
			</p>
		</div>
		...
		<div id="question">
			...
			<p>
				How many times has the for loop run?
			</p>
			<button id="btn1" onclick="Alert2.render('It is not correct. Try another one')">
				2
			</button>
			<button id="btn2" onclick="Alert1.render('Well Done! You are correct! You can move on to exercise part of chapter 3')">
				3
			</button>
