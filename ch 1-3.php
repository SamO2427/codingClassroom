<?php
	...
	if ($row[0] < 3)
	{
		$sql = "UPDATE account SET progress=3 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				You can show the number of candies you have on the screen with the following code:
			</p>
			<p style="text-align: center">
				cout << "I have 3 candies";
			</p>
			<p>
				cout is used to show the words
			</p>
			<p>
				The words in " " is the words you want to show
			</p>
			<p>
				After the code runs, the screen will show the words:
			</p>
			<p style="text-align: center">
				I have 3 candies
			</p>
		...
		<div id="question">
			...
			<p>
				Which of the following is used to show the words?
			</p>
