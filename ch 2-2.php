...
<html>	
	...
	<body>	
		<div id="notes">
			<p>For the game, you will lose 2 points if you lose</p>
			<p>if(w == true)</p>
			<p style="text-align: center">{pts = pts + 10;}</p>
			<p>else</p>
			<p style="text-align: center">{pts = pts - 2;}</p>
			<p>w == true is the condition</p>
			<p>When the condition is false, the code below else will work but the code below if(...) will not work</p>
			<p>When you have 10 points and then lost, your points will then be 8</p>
		</div>
		<div id="question">
			...
			<p>After you lose, what is the points you have?</p>
