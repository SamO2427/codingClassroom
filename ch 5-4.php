<?php
	...
	if ($row[0] < 44)
	{
		$sql = "UPDATE account SET progress=44 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				For every data member in a class, there are usually two member functions for setting and getting the value of it
			</p>
			<p>
				class abc
			</p>
			...
			<p>Member function seta is for setting and changing value of data member a and this type of member function is called setter</p>
			<p>Member function geta is for getting value of data member a and this type of member function is called getter</p>
		</div>

		<div id="question">
			<h3 style="text-align: center">Little Quiz</h3>
			<p>Which of the following is a setter in class abc?</p>
