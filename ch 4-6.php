<?php
	...
	if ($row[0] < 36)
	{
		$sql = "UPDATE account SET progress=36 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			...
			<p>In the case above, both values of b and c are 2</p>
			<p>After the function a, value of x becomes 2</p>
			<p>But when the function is called again, value of x change back to one at the beginning by the code x=1</p>
			<p>The code static int x will only run for 1 time, but the code x=1 will run everytime when the function is being called</p>
			<p>So the function will always return value 2</p>
		</div>

		<div id="question">
			<h3 style="text-align: center">Little Quiz</h3>
			<p>
				How many times has the code x=1 in the function run?
			</p>
			...
			<button id="btn3" onclick="Alert1.render('Well Done! You are correct! You can move on to exercise part of chapter 4')">
				2
			</button>
		</div>
		<div id="dbox">
