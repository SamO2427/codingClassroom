<?php
	...
	if ($row[0] < 33)
	{
		$sql = "UPDATE account SET progress=33 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				Global variables are made outside any function and can work in the whole program
			</p>
			<p>Global variables can also work in any function</p>
			<p>
				int abc = 1;
			</p>
			<p>
			...
			<p>
				In the example above, variable abc is made outside function x
			</p>
			<p>
				But function x can still use abc as abc is a global variable
			</p>
		</div>
		...
		<div id="question">
			...
			<p>
				What is the value that function x return?
			</p>
