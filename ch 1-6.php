<?php
	...
	if ($row[0] < 6)
	{
		$sql = "UPDATE account SET progress=6 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				When we get 3 more candies, we will have 5 candies
			</p>
			<p>
				We can change the value of candies to 5 by code:
			</p>
			<p style="text-align: center">
				candies = 5;
			</p>
			<p>
				or candies = candies + 3;
			</p>
			<p>
				Now, value of candies become 5
			</p>
		</div>
		...
		<div id="question">
			...
			<p>oranges = oranges + 1;</p>
			<p>What is value of oranges now?</p>
			<button id="btn1" onclick="Alert2.render('It is not correct. Try another one')">
				3
			</button>
			<button id="btn2" onclick="Alert1.render('Well Done! You are correct! You can move on to exercise part of chapter 1')">
				4
			</button>
