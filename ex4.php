<?php
	...
	if ($row[0] < 37)
	{
		$sql = "UPDATE account SET progress=37 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>	
	...
	<body onload="ex4lock()">
		...
		<div id="menu">
			<p>Menu</p>
			<a href="./ex4.1.php"><button id="button1" class="option">Ex4.1</button></a>
			<br>
			<a href="./ex4.2.php"><button id="button2" class="option">Ex4.2</button></a>
			<br>
			<a href="./chapter4.php"><button id="button3" class="option">Back</button></a>
		</div>
