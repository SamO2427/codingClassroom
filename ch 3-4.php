<?php
	...
	if ($row[0] < 24)
	{
		$sql = "UPDATE account SET progress=24 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			...
			<p>else {return b;}</p>
			<p>
				Branching and looping and also be done in the function
			</p>
			<p>For branching in function, if return type is not void, we need the return statement under any if-condition, else condition and else-if-condition</p>
			<p>
				In the function above, if a is smaller than b, it will return a
			</p>
			<p>
				If not, it will return b
			</p>
		</div>
