<?php
	...
	if ($row[0] < 53)
	{
		$sql = "UPDATE account SET progress=43 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				For the fubctions in the class, they are called member function of the class
			</p>
			<p>
				class abc
			</p>
			...
			<p>void c(){...}};</p>
			<p>
				In the class above, c is a member function of class abc
			</p>
			<p>
				The code public: means that the member functions in the class can be called by anyone
			</p>
			<p>We usually create member function under the code public:</p>
		</div>

		<div id="question">
			<h3 style="text-align: center">Little Quiz</h3>
			<p>
				Which of the following is a member function of class abc?
			</p>
