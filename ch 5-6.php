<?php
	...
	if ($row[0] < 46)
	{
		$sql = "UPDATE account SET progress=46 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>When we create a variable that is of the class type we create, we called it object</p>
			<p>When an object is created, the constructor is called, and constructor is used to set the initial value of data members in the class</p>
			<p>
				class abc
			</p>
			<p>
			...
			<p>public:</p>
			<p>abc(){a = 1;}</p>
			<p>void seta(int x){a=x;}</p>
			<p>int geta(){return a;}};</p>
			<p>In the class above, the constructor of class abc is used to set the initial value of data member a to 1</p>
		</div>
		...
		<div id="question">
			...
			<button id="btn1" onclick="Alert2.render('It is not correct. Try another one')">
				Get initial value of data member
			</button>
			<button id="btn2" onclick="Alert1.render('Well Done! You are correct! You can move on to exercise part of chapter 5')">
				Set initial value of data member
			</button>
			<button id="btn3" onclick="Alert3.render('It is not correct. Try another one')">
				Change initial value of data member
			</button>
		</div>
		<div id="dbox">
			<div id="dialog">
