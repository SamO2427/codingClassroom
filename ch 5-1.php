<?php
	...
	if ($row[0] < 41)
	{
		$sql = "UPDATE account SET progress=41 WHERE username = '{$_SESSION['login_user']}'";
	}
...
<html>
	...
	<body>
		<div id="notes">
			<p>
				When creating our own class, we must give it a name
			</p>
			<p>
				class abc
			</p>
			...
			<p>
				For the class above, the name is abc
			</p>
			<p>
				We usually need to have some variables and functions in the class and they are in { }
			</p>
			<p>
				At the end of { }, we must add ; when creating a class
			</p>
		</div>
		...
		<div id="question">
			...
			<p>{...}</p>
			<p>What is the name of the above class?</p>
